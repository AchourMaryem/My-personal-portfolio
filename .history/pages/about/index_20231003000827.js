...
Dans ce code, nous utilisons useState pour suivre la largeur de la fenêtre (windowWidth). Ensuite, dans l'effet useEffect, nous ajoutons un gestionnaire d'événement pour détecter les redimensionnements de fenêtre et mettre à jour windowWidth en conséquence. Si la largeur de la fenêtre est supérieure à 768 pixels, nous ajoutons la classe CSS overflow-y-scroll à la div principale pour activer la barre de défilement verticale.
