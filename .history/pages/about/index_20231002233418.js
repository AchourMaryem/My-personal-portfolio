...
const About = () => {
  ...
  return (
    ...
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left py-6 flex flex-col gap-y-4 xl:gap-y-4 mx-4 xl:overflow-y-auto xl:scrollbar-track-current ">
      <Circles />
      <motion.div
