  ...
  return <div className='bg-primary/60 h-full'>
   ...
   <div className="text-center flex flex-col justify-center xl:pt-50 xl:text-left h-full container mx-auto ">
        ...
        FullStack Web Developer
           ...
           <p className='max-w-sm xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16 text-lg' >I'am a final year software engineering student at Polytechnic School of Sousse, i am a motivated and ambitious person with a solid background in developement. I am able to work independently or as a team and manage multiple tasks simultaneously while meeting the deadlines.</p>
</div>
   </div>
       {/* image*/}
   <div>image</div>
