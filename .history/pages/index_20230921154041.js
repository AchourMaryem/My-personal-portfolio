...
const Home = () => {
  return (
    <div className='bg-primary/60 h-screen overflow-y-scroll'> {/* Utilisez "overflow-y-scroll" pour activer le défilement vertical */}
      {/* text */}
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto">
          ...
          <div style={{ height: '1000px' }}> {/* Exemple de contenu supplémentaire */}
