      ...
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="text-center flex flex-col justify-center xl:pt-50 xl:text-left h-full container mx-auto">
          ...
          {windowWidth > 768 && (
            ...
            >
With a love for creating digital experiences, I thrive on turning ideas into functional, user-friendly websites and mobile apps. I'm dedicated to continuous learning and enjoy the creative process of both front-end and back-end development.            </motion.p>
          )}
        </div>
      </div>
      {/* image */}
